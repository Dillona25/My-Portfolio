        ...
        <div className="w-[250px] md:w-[400px] mt-[20px]">
          ...
          >
            ...
            <textarea
              ...
              required
            ></textarea>
            <button class="relative px-5 py-3 w-[200px] mx-auto mt-[20px] bg-slate-100 overflow-hidden font-medium text-black border border-black rounded-lg shadow-inner group">
